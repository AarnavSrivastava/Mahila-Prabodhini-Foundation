...
{
    return (
        <nav className="flex flex-row w-screen sticky top-0 z-50 justify-between items-center bg-white-transparent py-[1%] px-[5%] gap-[10%]">
            <Link to="/" className ="flex group flex-row justify-start items-center basis-0 grow gap-[0.5vw]">
                ...
                <div className="flex flex-row group font-lato font-bold text-[1.1vw]">
            ...
            <ul className="flex basis-0 grow flex-row gap-5 font-opensans font-bold text-[0.9vw]">
            {/* flex w-[100%] h-[2.5vw] justify-center items-center border-2 border-defpink rounded-md text-white bg-defpink hover:text-defpink hover:bg-white */}
                <Link className="flex w-[100%] h-[2.5vw] justify-center items-center transition rounded-md text-white border-2 border-defpink ease-in-out delay-10 bg-defpink hover:bg-white hover:text-defpink duration-300" to="/">
                    LOGIN
                </Link>
                <Link className="flex w-[100%] h-[2.5vw] justify-center items-center transition rounded-md text-defpink border-2 border-defpink ease-in-out delay-10 bg-white hover:bg-defpink hover:text-white duration-300" to="/signup">
                    SIGN UP
                </Link>
                <Link className="flex w-[100%] h-[2.5vw] justify-center items-center transition rounded-md border-2 border-[#158ba8] rounded-md text-[#158ba8] ease-in-out delay-10 bg-white hover:text-white hover:bg-[#158ba8] duration-300" to="/donate">
                    DONATE
                </Link>
            </ul>
        </nav>
...
function CustomLink({ to, children })
{
    ...
    return (
        <li className="flex font-lato font-black text-[1.1vw]">
