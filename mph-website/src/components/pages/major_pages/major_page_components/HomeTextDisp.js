...
const HomeTextDisp = () => {
    return (
        <div className="transform bg-[#FFF5F5] relative px-[10vw] flex flex-col justify-start items-center">
            ...
            <div className="py-[10%] grid grid-cols-4 grid-flow-row auto-rows-fr font-poppins font-black text-white md:text-[1.5vw] text-[12px] leading-[3vw]">
                <div className="flex flex-col px-[2vw] py-[2vw] bg-[#B16987]">
                    Education
                    <div className="py-[4vh] font-lato font-light text-white md:text-[1.3vw] text-[10px]">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec facilisis fermentum nisi, eget tincidunt justo euismod ac.
                    </div>
                    <div className="bg-white mt-[2vh] mb-[5vh] w-[4vw] h-[0.6vh]" />
                </div>
